...
const EditProducts = () => {
  return (
    <div className="min-h-[calc(100vh-48px)] bg-gradient-to-b from-[#06b5d4] to-[#3b82f5] max-w-7xl w-full mx-auto my-6 rounded-xl flex items-center justify-center flex-col">
