...
const ViewOrder = () => {
  ...
  const handleCopy = () => {
    ...
    navigator.clipboard
      ...
      .then(() => toast.success("Customer details copied to clipboard!"))
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-3 bg-gray-50 shadow-lg rounded-lg p-6">
          <div className="flex flex-wrap gap-4 mb-6 text-sm">
            ...
            <div className="p-2 bg-yellow-200 rounded">
              <strong>Payment Status:</strong> {getStatusLabel.payment}
            </div>
            <div className="p-2 bg-blue-200 rounded">
              <strong>Order Status:</strong> {getStatusLabel.order}
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2 bg-gray-50 shadow-lg rounded-lg p-6">
          ...
          <div className="text-right mb-6">
            ...
            <p>
              <strong>Grand Total:</strong> {order.grandTotal || 0}
            </p>
          </div>
